...
\chapter[Paper \liningfigures{B1} -- CoFaaS: Automatic Consolidation of Serverless Functions][Paper \liningfigures{B1} -- CoFaaS: Consolidation of Serverless Functions]{Paper \liningfigures{B1} -- CoFaaS: Automatic Transformation-based Consolidation of Serverless Functions }
