...
We present our results in two parts where the first part
...
A2, A3 and A4 (\Cref{chap:cal-paper,chap:pact-paper,chap:u hpca-paper}).
...
this analysis, shown in \Cref{fig:offset-distr} we make the
