...
instruction cache \liningfigures{L1-I} and the Branch Target Buffer (BTB). In order to
handle this problem, computer architects has proposed a large number
of different approaches. \liningfigures{L1-I} prefetchers are a highly effective way
to alleviate the front-end bottleneck as they help avoiding the
fill-latency that follows an \liningfigures{L1-I} miss.  As detailed
