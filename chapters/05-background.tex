...
imporves the miss coverage of Boomerang further by introducing an
optimized BTB organization constiting of three structures. The U-BTB
...
\texttt{if} block or a loop. Furthermore, program control flow structure often follow a pattern where a (long) unconditional jump precedes a sequence of multiple (short) conditional jumps. TO
