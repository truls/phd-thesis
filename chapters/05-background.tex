...
reasons: \begin{inparaenum}[1)] \item Realistically sized BTBs are too
  ...
  control flow predictions generated by the branch predictor would stay on the right path for long enough to cover the large LLC fetch delay encountered in modern processors.
\end{inparaenum}
