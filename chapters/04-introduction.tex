...
Buffer (BTB) (see \Cref{chap:btb-background}) organization for
...
instruction prefetching performance \truls{Add a reference to
  background section that elaborates on this correlation}. Thereby, it helps alleviating the
