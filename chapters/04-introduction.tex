...
\truls{There is a slight leap in this argument since we do not
  directly show that BTB-X works to improve the performance of the
  functions that we measure the WoSC paper}
...
several functions are executed simultaneously on the same processor
