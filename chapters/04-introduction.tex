...
software platforms for effectively executing FaaS applications. To
that end, the research presented in this thesis follows two
...
From fromt his work, we draw the conclusions that only functions with
