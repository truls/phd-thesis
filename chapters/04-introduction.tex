...
\begin{framed}
\noindent
\textbf{Identify sources of inefficiencies in FaaS applications, why they occur and to propose hardware and software mechanisms to alleviate these inefficiencies.}
\end{framed}
\noindent
