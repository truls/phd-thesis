...
developers. To maximize these benefits developers are encouraged to
keep each individual FaaS function small with a narrowly defined
purpose. Hence, many FaaS function shave short running times, often
less than 1
...
The complete CoFaaS design and implementation is described in Paper E~\Cref{chap:cofaas-paper}
